...
export default function ChangementFiliereForm(props: {
    ...
    <Animated.View entering={SlideInRight} exiting={SlideOutLeft}>
      <View className="w-screen h-full flex items-center ">
        ...
        <View className="flex justify-center flex-row space-x-5">
          ...
          <Pressable  className="flex  rounded-md w-[40%] justify-center items-center  p-3 bg-[#e0e1f3]" onPress={() => props.setVisible(false)}>
            <Text>Annuler</Text>
          </Pressable>
        </View>
      </View>

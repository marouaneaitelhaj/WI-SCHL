  ...
  return (
    ...
    >
      <View className=" h-14 w-14 flex rounded-full justify-center items-center bg-[#D0EBFE]">
        <Text className="font-[Poppins-Black]  text-center font-bold text-[#5156BE]">
          {props.month}
        </Text>
      </View>
      <View className="w-20  flex justify-center items-center h-14 rounded-lg bg-[#D4FFEB]">
        ...
        <Text className="font-[Poppins-Black]  text-center font-normal text-[#25A168]">Present</Text>
      </View>
      <View className="w-20  flex justify-center items-center  h-14 rounded-lg bg-[#FED4D5]">
        ...
        <Text className="font-[Poppins-Black]  text-center font-normal text-[#F83A6C]">Absent</Text>
      </View>

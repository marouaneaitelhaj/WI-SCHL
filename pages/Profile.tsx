    ...
    <ScrollView className="my-2 w-full">
      ...
      <View className="space-y-5 px-5 my-5">
        ...
        <View className="flex flex-row space-x-2 w-full border-b-[0.25px] pb-4 border-[#C30790]">
          ...
          <Text className="text-[#C30790] w-2/3">{user?.cin}</Text>
        </View>
        <View className="flex flex-row space-x-2 w-full border-b-[0.25px] pb-4 border-[#C30790]">
          <Text className="text-[black] w-1/3">Cne:</Text>
          <Text className="text-[#C30790] w-2/3">{user?.cne}</Text>
        </View>
        <View className="flex flex-row space-x-2 w-full border-b-[0.25px] pb-4 border-[#C30790]">
          <Text className="text-[black] w-1/3">Code inscription:</Text>
          <Text className="text-[#C30790] w-2/3">{user?.code_inscription}</Text>
        </View>
        <View className="flex flex-row space-x-2 w-full border-b-[0.25px] pb-4 border-[#C30790]">
          <Text className="text-[black] w-1/3">Date naissance:</Text>
          <Text className="text-[#C30790] w-2/3">{user?.date_naissance}</Text>
        </View>
        <View className="flex flex-row space-x-2 w-full border-b-[0.25px] pb-4 border-[#C30790]">
          <Text className="text-[black] w-1/3">Lieu naissance_fr:</Text>
          <Text className="text-[#C30790] w-2/3">
            {user?.lieu_naissance_fr}
          </Text>
        </View>
        <View className="flex flex-row space-x-2 w-full border-b-[0.25px] pb-4 border-[#C30790]">
          <Text className="text-[black] w-1/3">Adresse fr:</Text>
          <Text className="text-[#C30790] w-2/3">{user?.adresse_fr}</Text>
        </View>
        <View className="w-full flex justify-center items-center ">
          <Pressable
            ...
            className={
              "flex rounded-md w-[90%] justify-center items-center  p-5 bg-[#C30790]"
            }
          >
